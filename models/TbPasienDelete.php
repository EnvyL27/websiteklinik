 ...
 * Page class
 */
class TbPasienDelete extends TbPasien
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TbPasienDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("tbpasienlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("tbpasienlist"); // Return to list
                return;
            }
        }
