 ...
 * Page class
 */
class TbPasienView extends TbPasien
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TbPasienView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("tbpasienlist"); // Return to list page
                        return;
                        ...
                        while (!$this->Recordset->EOF) {
                            if (SameString($this->id_pasien->CurrentValue, $this->Recordset->fields['id_pasien'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "tbpasienlist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "tbpasienlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
