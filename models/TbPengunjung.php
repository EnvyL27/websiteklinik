...
/**
 * Table class for tb_pengunjung
 */
class TbPengunjung extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'tb_pengunjung';
        $this->TableName = 'tb_pengunjung';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`tb_pengunjung`";
        $this->Dbid = 'DB';
        ...
        // id
        $this->id = new DbField('tb_pengunjung', 'tb_pengunjung', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // id_pasien
        $this->id_pasien = new DbField('tb_pengunjung', 'tb_pengunjung', 'x_id_pasien', 'id_pasien', '`id_pasien`', '`id_pasien`', 3, 11, -1, false, '`id_pasien`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // tanggal
        $this->tanggal = new DbField('tb_pengunjung', 'tb_pengunjung', 'x_tanggal', 'tanggal', '`tanggal`', CastDateFieldForLike("`tanggal`", 0, "DB"), 133, 10, 0, false, '`tanggal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`tb_pengunjung`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("tbpengunjunglist");
    }
    ...
    {
        global $Language;
        if ($pageName == "tbpengunjungview") {
            return $Language->phrase("View");
        } elseif ($pageName == "tbpengunjungedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "tbpengunjungadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TbPengunjungView";
            case Config("API_ADD_ACTION"):
                return "TbPengunjungAdd";
            case Config("API_EDIT_ACTION"):
                return "TbPengunjungEdit";
            case Config("API_DELETE_ACTION"):
                return "TbPengunjungDelete";
            case Config("API_LIST_ACTION"):
                return "TbPengunjungList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("tbpengunjungview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("tbpengunjungview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "tbpengunjungadd?" . $this->getUrlParm($parm);
        } else {
            $url = "tbpengunjungadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("tbpengunjungedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("tbpengunjungadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("tbpengunjungdelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    {
        //Log("Row Inserted");
        $pasien = $rsnew["id_pasien"];
        $tanggal = $rsnew["tanggal"];
         $sql = Execute("INSERT INTO tb_periksa (id_pasien, tanggal)
                        VALUES('".$pasien."', '".$tanggal."')");
    }
