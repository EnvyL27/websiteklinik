 ...
 * Page class
 */
class TbPengunjungDelete extends TbPengunjung
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TbPengunjungDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("tbpengunjunglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("tbpengunjunglist"); // Return to list
                return;
            }
        }
