 ...
 * Page class
 */
class TbPengunjungEdit extends TbPengunjung
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TbPengunjungEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // id_pasien
            $this->id_pasien->setDbValueDef($rsnew, $this->id_pasien->CurrentValue, 0, $this->id_pasien->ReadOnly);
