 ...
 * Page class
 */
class TbPengunjungView extends TbPengunjung
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TbPengunjungView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("tbpengunjunglist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "tbpengunjunglist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "tbpengunjunglist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
