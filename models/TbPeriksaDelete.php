 ...
 * Page class
 */
class TbPeriksaDelete extends TbPeriksa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TbPeriksaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("tbperiksalist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("tbperiksalist"); // Return to list
                return;
            }
        }
