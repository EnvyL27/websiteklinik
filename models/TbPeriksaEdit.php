 ...
 * Page class
 */
class TbPeriksaEdit extends TbPeriksa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TbPeriksaEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // keluhan
            $this->keluhan->setDbValueDef($rsnew, $this->keluhan->CurrentValue, "", $this->keluhan->ReadOnly);

            // diagnosa
            $this->diagnosa->setDbValueDef($rsnew, $this->diagnosa->CurrentValue, "", $this->diagnosa->ReadOnly);

            // terapi
            $this->terapi->setDbValueDef($rsnew, $this->terapi->CurrentValue, "", $this->terapi->ReadOnly);

            // hasilPeriksa
            $this->hasilPeriksa->setDbValueDef($rsnew, $this->hasilPeriksa->CurrentValue, "", $this->hasilPeriksa->ReadOnly);

            // tarif
            $this->tarif->setDbValueDef($rsnew, $this->tarif->CurrentValue, 0, $this->tarif->ReadOnly);
