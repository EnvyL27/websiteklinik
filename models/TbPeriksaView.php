 ...
 * Page class
 */
class TbPeriksaView extends TbPeriksa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TbPeriksaView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("tbperiksalist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "tbperiksalist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "tbperiksalist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
