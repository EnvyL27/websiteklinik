...
/**
 * Table class for v_pengunjung_hariini
 */
class VPengunjungHariini extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_pengunjung_hariini';
        $this->TableName = 'v_pengunjung_hariini';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_pengunjung_hariini`";
        $this->Dbid = 'DB';
        ...
        // id
        $this->id = new DbField('v_pengunjung_hariini', 'v_pengunjung_hariini', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // id_pasien
        $this->id_pasien = new DbField('v_pengunjung_hariini', 'v_pengunjung_hariini', 'x_id_pasien', 'id_pasien', '`id_pasien`', '`id_pasien`', 3, 11, -1, false, '`id_pasien`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // tanggal
        $this->tanggal = new DbField('v_pengunjung_hariini', 'v_pengunjung_hariini', 'x_tanggal', 'tanggal', '`tanggal`', CastDateFieldForLike("`tanggal`", 0, "DB"), 133, 10, 0, false, '`tanggal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_pengunjung_hariini`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("vpengunjunghariinilist");
    }
    ...
    {
        global $Language;
        if ($pageName == "vpengunjunghariiniview") {
            return $Language->phrase("View");
        } elseif ($pageName == "vpengunjunghariiniedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "vpengunjunghariiniadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VPengunjungHariiniView";
            case Config("API_ADD_ACTION"):
                return "VPengunjungHariiniAdd";
            case Config("API_EDIT_ACTION"):
                return "VPengunjungHariiniEdit";
            case Config("API_DELETE_ACTION"):
                return "VPengunjungHariiniDelete";
            case Config("API_LIST_ACTION"):
                return "VPengunjungHariiniList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("vpengunjunghariiniview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("vpengunjunghariiniview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "vpengunjunghariiniadd?" . $this->getUrlParm($parm);
        } else {
            $url = "vpengunjunghariiniadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vpengunjunghariiniedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vpengunjunghariiniadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("vpengunjunghariinidelete", $this->getUrlParm());
    }
