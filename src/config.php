...
$CONFIG = [
    ...
    "RANDOM_KEY" => '3gtUJs9wfWsZlpGi', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/webklinik.css", // Project stylesheet file name
    ...
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-success navbar-dark border-bottom-0",
    ...
    "ADMIN_PASSWORD" => "adminklinik", // Administrator password
