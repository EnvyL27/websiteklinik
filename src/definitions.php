...
return [
    ...
    // Tables
    "tb_admin" => \DI\create(TbAdmin::class),
    "tb_pasien" => \DI\create(TbPasien::class),
    "tb_pengunjung" => \DI\create(TbPengunjung::class),
    "tb_periksa" => \DI\create(TbPeriksa::class),
    "tbobat" => \DI\create(Tbobat::class),
    "v_pengunjung_hariini" => \DI\create(VPengunjungHariini::class),
    "v_pengunjung_thismonth" => \DI\create(VPengunjungThismonth::class),
];
