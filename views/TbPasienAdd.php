...
loadjs.ready("head", function () {
    ...
    ftb_pasienadd = currentForm = new ew.Form("ftb_pasienadd", "add");
    ...
    // Validate form
    ftb_pasienadd.validate = function () {
    ...
    // Form_CustomValidate
    ftb_pasienadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftb_pasienadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("ftb_pasienadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="ftb_pasienadd" id="ftb_pasienadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["ftb_pasienadd", "datetimepicker"], function() {
    ew.createDateTimePicker("ftb_pasienadd", "x_tgl_lahir", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
